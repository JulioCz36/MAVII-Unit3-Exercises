...
void Game::DoEvents()
{
    ...
    //Reacciona al imput
    cuadradoBody->SetAwake(true);
    if (Keyboard::isKeyPressed(Keyboard::Left))
        cuadradoBody->SetLinearVelocity(b2Vec2(-30.0f, 0.0f));
    if (Keyboard::isKeyPressed(Keyboard::Right))
        cuadradoBody->SetLinearVelocity(b2Vec2(30.0f, 0.0f));
    if (Keyboard::isKeyPressed(Keyboard::Down))
        cuadradoBody->SetLinearVelocity(b2Vec2(0.0f, 30.0f));
...
void Game::InitPhysics()
{
    ...
    // Crear un cuadrado
    cuadradoBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 5.0f, 5.0f, 1.0f, 0.5f, 0.1f);
    cuadradoBody->SetTransform(b2Vec2(50.0f, 50.0f), 0.0f);
}
